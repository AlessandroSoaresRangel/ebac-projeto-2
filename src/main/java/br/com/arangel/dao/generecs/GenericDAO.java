package main.java.br.com.arangel.dao.generecs;

import main.java.br.com.arangel.annotation.TipoChave;
import main.java.br.com.arangel.dao.SingletonMap;
...
public abstract class GenericDAO<T extends Persistente, E > implements IGenericDAO<T,E> {
